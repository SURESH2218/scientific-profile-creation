...
const ProfileHeader: React.FC = () => {
  ...
  return (
    <div className="section-reveal w-full py-6 md:py-8 grid grid-cols-1 md:grid-cols-12 gap-8">
      {/* Avatar Section - spans 4 columns on desktop */}
      ...
      {/* Main Content Section - spans 4 columns on desktop */}
      <div className="col-span-1 md:col-span-6 space-y-3 md:space-y-4">
        <div className="space-y-2">
          ...
          <h2 className="text-base md:text-lg text-muted-foreground">
            Medicinal Chemist specializing in lipid synthesis and drug delivery
            systems
          </h2>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-950/20 dark:to-indigo-950/20 p-3 rounded-lg border border-purple-100 dark:border-purple-800/30">
          <p className="text-sm md:text-base leading-relaxed">
            Over seventeen years of experience working in synthetic chemistry
            labs as a medicinal chemist and team leader, with extensive
            understanding and knowledge in the synthesis of a broad spectrum of
            lipid architectures, nucleotides (mRNA caps), and small molecules to
            enable a wide variety of therapeutic applications.
          </p>
        </div>
            ...
            <div className="pt-2 border-t border-white/10">
              ...
              <div className="flex flex-wrap gap-2">
                <Badge className="bg-white/10 backdrop-blur-sm text-foreground hover:bg-white/20 text-xs">
                  Molecular Modeling (Schrödinger, 2022)
                </Badge>
                <Badge className="bg-white/10 backdrop-blur-sm text-foreground hover:bg-white/20 text-xs">
                  Business Analysis (UBC, 2023)
                </Badge>
              </div>
            </div>

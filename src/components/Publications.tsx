...
import { FileText, ExternalLink, Star, BookOpen, Award, ThumbsUp } from 'lucide-react';
...
const Publications: React.FC = () => {
  const [highlightedPatent, setHighlightedPatent] = useState<number | null>(null);
  ...
  return (
    <div className="section-reveal py-8">
      <div className="flex items-center mb-6">
        ...
        <h2 className="text-2xl font-bold">Patents & Publications</h2>
      </div>
      
      <Tabs defaultValue="patents" className="w-full">
        <TabsList className="grid w-full grid-cols-2 neo-glass mb-6">
          <TabsTrigger value="patents" className="data-[state=active]:bg-accent data-[state=active]:text-white">
            <FileText className="mr-2 h-4 w-4" /> Patents
          </TabsTrigger>
          <TabsTrigger value="publications" className="data-[state=active]:bg-accent data-[state=active]:text-white">
        ...
        <TabsContent value="patents" className="space-y-4">
          {[
            ...
            {
              id: 3,
              title: "Method for producing ionizable lipids or intermediates for the synthesis of such lipids",
              authors: "Atmuri N D P.; Arnold D.; Saadati F.; Kurek D.; Kulkarni J.; Witzigmann D.; Ciufolini M.",
            ...
            <Card 
              ...
              className={`neo-glass transition-all duration-300 ${
                highlightedPatent === patent.id ? 'ring-2 ring-accent shadow-lg' : ''
              }`}
            ...
            >
              <CardHeader className="pb-2">
                <CardTitle className="flex justify-between items-start">
                  ...
                  <Badge className="bg-white/10 backdrop-blur-sm text-foreground">{patent.date}</Badge>
                </CardTitle>
                <CardDescription className="text-sm">{patent.authors}</CardDescription>
              </CardHeader>
        ...
        <TabsContent value="publications" className="space-y-4">
          {[
            {
              ...
              authors: "Sedki D.; Cho A.; Cao Y.; Nikolajev L.; Atmuri N. D. P.; Lubell W. D.; Laporte S. A.",
              journal: "J. Biol. Chem.",
              year: "2022",
              volume: "298(9)",
              pages: "102294",
            ...
            {
              id: 2,
              title: "Losartan metabolite EXP3179 is a unique blood pressure-lowering AT1R antagonist with direct, rapid endothelium-dependent vasoactive properties",
            ...
            {
              id: 3,
              title: "Stereo- and regiochemical transannular cyclization of a common hexahydro-1H-azonine to afford three different indolizidinone dipeptide mimetics",
            ...
            {
              id: 4,
              title: "Paired Utility of Aza-Amino Acyl Proline and Indolizidinone Amino Acid Residues for Peptide Mimicry: Conception of Prostaglandin F2a Receptor Allosteric Modulators that Delay Preterm Birth",
              authors: "Fatemeh M. M.*; Atmuri, N. D. P.*; Bourguet, C. B.; Jennifer R. F.; Hou X.; Chemtob S.; Lubell W. D.",
              journal: "J. Med. Chem.",
              year: "2019",
              volume: "62",
              pages: "4500–4525",
            ...
            <Card 
              key={paper.id} 
              className={`neo-glass transition-all duration-300 ${
                highlightedPaper === paper.id ? 'ring-2 ring-accent shadow-lg' : ''
              }`}
            ...
            >
              <CardHeader className="pb-2">
                ...
                <CardDescription className="text-sm">
                  {paper.authors}
                  {paper.note && <span className="italic ml-1">({paper.note})</span>}
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-0">
          ...
          <Card className="neo-glass">
            ...
            <CardContent>
              <div className="text-sm font-medium">"Ring Closing Metathesis / Transannular Cyclization to Azabicyclo[X.Y.0]alknanone Dipeptide Turn Mimics"</div>
              <div className="text-sm mt-1">
                Atmuri, N. D. P.; Surprenant, S.; Diarra, S.; Bourguet, C.; Lubell, W. D.
              </div>
              <div className="text-sm text-muted-foreground mt-2">
                Elsevier Book Project - Peptide and Peptidomimetic Therapeutics: From Bench to Bedside.
                <br />
                Academic Press, 2022, ISBN-0128204478, 9780128204474, Chapter 6. Page 125–147.
              </div>
          ...
          <div className="premium-glass p-4 rounded-xl mt-2">
            <div className="flex items-center mb-2">
              ...
              <h3 className="text-lg font-semibold">Work Highlighted by Scientific Community:</h3>
            </div>
            <ul className="list-disc pl-5 space-y-1">
              <li>Cover page of The Journal of Organic Chemistry 2020, Volume 85, Issue 3, "Modern Peptide and Protein Chemistry."</li>
              <li>

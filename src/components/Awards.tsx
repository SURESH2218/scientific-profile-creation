  ...
  const conferences = [
    {
      id: 1,
      title:
        "Peptidomimetic Synthesis by Transannular Cyclization and Iodoacetoxylation",
      authors: "Atmuri, N. D. P.; Lubell, W. D.",
      venue:
        "28th Québec-Ontario Mini-Symposium for Synthetic and Bioorganic Chemistry, McGill, Montreal",
    ...
    },
    {
      id: 2,
      title:
        "A general synthetic strategy for making azabicyclo[X.Y.0]alkanone peptidomimetics",
      authors: "Atmuri, N. D. P.; Lubell, W. D.",
      venue:
        "The 19th Concordia Chemistry and Biochemistry Graduate Research Conference, Concordia Univerity, Montreal",
    ...
    },
    {
      ...
      authors: "Atmuri, N. D. P.; Lubell, W. D.",
      venue:
        "GRUM- Groupe de recherche Universitaire sur le médicament, Université de Montréal",
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
            {awards.map((award) => (
              <Card
                key={award.id}
                className=" overflow-hidden border-purple-600/20"
              >
